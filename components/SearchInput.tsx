    ...
    <form onSubmit={handleSubmit} className="mb-6">
      <div className="relative">
        <input
          ...
          placeholder="Search..."
          className="w-full px-4 py-2 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 text-black dark:text-white"
        />
        <button
          type="submit"
